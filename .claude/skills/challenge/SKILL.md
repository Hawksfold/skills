---
name: challenge
description: Stress-test a plan, decision, or argument with a calibrated, balanced counter-view — surfaces the load-bearing assumption, triages objections by severity, and ends with the cheapest test to settle the question. Use when the user wants to challenge, red-team, pressure-test, poke holes in, sanity-check, or get a devil's-advocate / second opinion on a plan, proposal, strategy, or decision.
---
...
1. **The plan, in one line** — so it's clear what's being challenged.
2. **Load-bearing assumption** — the single thing that must be *true* for the plan to work (a premise, not a flaw). State it upstream of the objections, and **don't let it just restate objection #1.** If there's no hidden premise, skip this line rather than pad it.
